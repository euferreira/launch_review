#import "LaunchAppStorePlugin.h"

@implementation LaunchAppStorePlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    FlutterMethodChannel* channel = [FlutterMethodChannel
                                     methodChannelWithName:@"launch_app_store"
                                     binaryMessenger:[registrar messenger]];
    LaunchAppStorePlugin* instance = [[LaunchAppStorePlugin alloc] init];
