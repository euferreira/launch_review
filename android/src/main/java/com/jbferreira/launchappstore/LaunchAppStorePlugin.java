package com.jbferreira.launchappstore;
...
/**
 * LaunchAppStorePlugin
 */
public class LaunchAppStorePlugin implements MethodCallHandler, FlutterPlugin, ActivityAware {
    private Activity activity;
    private MethodChannel channel;

    @Override
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        channel = new MethodChannel(binding.getBinaryMessenger(), "launch_app_store");
